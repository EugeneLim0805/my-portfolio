const Navbar = () => (
  <nav className="w-full py-3 bg-white/95 backdrop-blur-sm flex justify-center fixed top-0 left-0 z-50">
    <div className="w-full px-8 flex justify-between items-center">
      <a href="#home" className="font-semibold text-lg text-gray-900 hover:text-gray-700 transition-colors duration-200">
      ...
      <ul className="flex space-x-8">
        {[
          ...
          <li key={item.label}>
            <a
              href={item.href}
              className="text-base font-medium text-gray-600 hover:text-gray-900 transition-colors duration-200 relative
